...
- [Keyword backlog](project_keyword_backlog.md) - data-backed low-KD blog opportunities (Semrush, Jul 2026); 7 posts written 2026-07-19 (incl. GTM engineer pillar, PMM career path, win-loss questions) + aeo-vs-seo optimized (added answer box, ~pos 34 for "seo vs aeo"); footprint log (anti-sameness) + review ledger feed the `/swapblog-optimize` loop
