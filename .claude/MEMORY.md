...
- [Keyword backlog](project_keyword_backlog.md) - data-backed low-KD blog opportunities (Semrush); 7 posts 2026-07-19 + 7 on 2026-07-25 + **5 on 2026-08-15** (analyst-relations 390/KD 12, customer-success-story-template 480/**KD 2**, price-increase-announcement 90/KD 15, product-sunset 70/KD 10, sales-kickoff-agenda 170/KD 12). **All 4 striking-distance posts optimized 2026-08-15** (aeo-vs-seo retargeted to the 3-way GEO term; customer-enablement got its missing implementation layer; growth-vs-performance got its two missing definition H2s; product-marketing-team-structure got the roles section it needed to rank for its own title term) - re-measure ~2026-09-26. "Write next" tier refilled with 14 dedup-checked candidates; biggest veins are product naming (~2,300) and customer advocacy/references (~1,700). Ahrefs OVER quota until 2026-08-21. **Corpus health escalating: 8 of last 9 posts `synthesized` - ASK for a first-hand artifact before the next write**
