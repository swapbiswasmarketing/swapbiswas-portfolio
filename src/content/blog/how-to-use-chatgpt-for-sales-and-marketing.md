...
faqs:
  ...
  - q: "Is ChatGPT good for sales outreach?"
    a: "Yes, for personalization at scale and first drafts - but not as a send-button tool. ChatGPT excels at researching prospects, generating opening lines, rewriting templates for specific personas, and drafting follow-up sequences. Every output still needs a human review before it hits a prospect's inbox."
  - q: "What is the best prompt format for marketing tasks?"
    a: "Use the Role + Context + Goal + Constraints format. Assign ChatGPT a specific role, provide context about your company and target audience, state the exact output you want, and list constraints like tone, length, and format. Generic prompts produce generic output."
  - q: "Is it safe to put company data into ChatGPT?"
    a: "Only if you use an enterprise or team tier with data controls, or if you have explicit permission from your security team. Free and personal accounts train on your inputs unless you opt out. Never paste customer data, contracts, financials, or roadmap documents into a free ChatGPT account."
howTo:
  name: "How to Use ChatGPT for Sales and Marketing"
  steps:
    - name: "Assign ChatGPT a Role"
      text: "Tell ChatGPT who it is pretending to be. A specific role like 'You are a B2B SaaS product marketer with 8 years of experience' sets the tone, voice, and expertise level for every output that follows."
    - name: "Provide Company and Audience Context"
      text: "Describe what your company does, who your audience is, and what the situation is. The more specific the context, the more specific and usable the output will be."
    - name: "State the Exact Goal"
      text: "Specify exactly what you want ChatGPT to produce. A goal like 'Write a 75-word cold email to a VP of Sales at a Series B SaaS company' beats 'write me a cold email' every time."
    - name: "Set Constraints"
      text: "List tone, length, format, and anything to avoid. Constraints like 'casual tone, under 90 words, no emdashes, end with a soft CTA' turn ChatGPT output from generic draft into usable copy."
---
...
1. **Role** - who ChatGPT is pretending to be ("You are a B2B SaaS product marketer with 8 years of experience")
2. **Context** - what your company does, who the audience is, what the situation is ("We sell workflow automation to HR teams at 200-2,000 employee companies")
3. **Goal** - the exact output you want ("Write a 150-word cold email to a VP of HR")
4. **Constraints** - tone, length, format, anything to avoid ("Casual tone, no emdashes, no questions in the opening, under 90 words")
...
![ChatGPT prompt framework for sales and marketing](/assets/blog/how-to-use-chatgpt-for-sales-and-marketing/prompt-framework.webp "ChatGPT Prompt Framework")
...
The key word is "avoid generic statements." Without that constraint, ChatGPT will produce vague filler. See our [competitive battlecard template](/blog/competitive-battlecard-template/) for the full structure.
...
The "challenge rather than affirm" constraint is critical. ChatGPT defaults to being agreeable, which makes it useless as a critic unless you explicitly tell it otherwise. For more on ICPs, see our guide on [ICP vs buyer persona](/blog/icp-vs-buyer-persona/).
...
If you want a deeper prompt library to work from, see our collection of [ChatGPT prompts for marketing](/blog/chatgpt-prompts-for-marketing/).
