---
title: "Product Positioning: Framework, Statement, and Examples"
description: "Product positioning explained by a PMM: the six-part framework, how to write a positioning statement, real examples, and the mistakes that flatten it."
...
|---|---|---|
| **Focus** | Specific product or feature | Entire company identity |
| **Scope** | Functional benefits + differentiation | Emotional connection + values |
| **Changes** | Per product, per market segment | Rarely - it's your north star |
...
**1. Positioning on features, not outcomes.**
"We have AI-powered analytics" means nothing. "Find your best customers 10x faster" means everything.

**2. Trying to appeal to everyone.**
If your positioning doesn't exclude anyone, it doesn't attract anyone either. The best positioning is polarizing.

**3. Ignoring the competitive context.**
Positioning doesn't exist in a vacuum. If you don't explicitly address what you're better than, customers will fill in the blanks themselves - and they'll usually get it wrong.

**4. Writing positioning in a conference room.**
Positioning that comes from internal brainstorming sessions instead of customer conversations is almost always wrong. Start with customer research, not a whiteboard.

**5. Setting it and forgetting it.**
Markets change. Competitors launch new features. Customer needs evolve. Review your positioning quarterly.
...
Use your [ICP and buyer persona definitions](/blog/icp-vs-buyer-persona/) to select the right customers for step 1, and our [competitive analysis examples](/blog/competitive-analysis-examples/) provide ready-to-use frameworks for step 2. Step 5 goes faster when the positioning statement is an artifact rather than a paragraph in a doc, so [lay the six elements out on a single page](/tools/product-one-pager-template/) and let reps tell you within one call which of them is still too vague to say out loud.
...
**Related reading:**
- [What Is Product Marketing?](/blog/what-is-product-marketing/) - The complete guide to the role that owns positioning
- [AI SEO Strategy](/blog/ai-seo-strategy/) - How to position your content for search and AI overviews
- [Go-To-Market Strategy Template](/blog/go-to-market-strategy-template/) - Where positioning fits in your GTM plan
- [Marketing Strategy for New Product](/blog/marketing-strategy-for-new-product/) - Applying positioning to a product launch
