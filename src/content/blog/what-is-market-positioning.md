...
faqs:
  ...
  - q: "What is the difference between market positioning and brand positioning?"
    a: "Market positioning answers 'where does our product sit in the market and why is it the best choice for a specific customer?' Brand positioning answers 'what does our company stand for and how do customers feel about us?' Market positioning is sharper, often product-level, and shorter-lived. Brand positioning is the long-arc emotional identity."
  - q: "Who owns market positioning in a company?"
    a: "In SaaS and most B2B companies, product marketing owns positioning, with sign-off from the CMO and the founder or CEO. Sales contributes the daily reality check, and customer research provides the ground truth. Positioning that is owned by no one drifts into whichever team writes the next landing page."
  - q: "How often should market positioning be reviewed?"
    a: "Annually as a standing review, and on three triggers: a new competitor entering the category, a major product expansion, or a meaningful shift in the buyer (segment, persona, use case). Most teams reposition too rarely. The cost of stale positioning is paid by sales every quarter in lost deals."
  - q: "What makes market positioning weak?"
...
1. **What is this?** (the market category the buyer should compare you in)
...
![Market positioning framework with five components feeding into a positioning statement template](/assets/blog/what-is-market-positioning/positioning-framework.webp "Market Positioning Framework")
...
1. Five customers (do they recognize themselves?)
2. The sales team (can they pitch it without translating?)
3. The product team (does it match what is actually in the roadmap?)

Reject the draft if any of the three groups push back materially. Iterate.

### Week 4: Roll Out

Lock the document. Update the messaging house, homepage, sales deck, and demo script. For the sales-facing translation, see [the sales enablement checklist](/blog/sales-enablement-checklist/).
...
For the wider operating frame this work plugs into, see [what is product marketing](/blog/what-is-product-marketing/) and [go-to-market strategy template](/blog/go-to-market-strategy-template/).
