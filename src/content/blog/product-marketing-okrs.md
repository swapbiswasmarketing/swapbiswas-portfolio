...
faqs:
  ...
  - q: "How many OKRs should a PMM team set per quarter?"
    a: "Two to three objectives, with 2-4 key results under each. Five objectives is a to-do list; one objective is a job description. The job of an OKR is to force prioritization, so keep the list short enough that everyone on the team can recite it without looking."
  - q: "What is the difference between a PMM OKR and a KPI?"
    a: "A KPI is a metric you monitor continuously, like win rate or pipeline influenced. An OKR is a time-boxed stretch goal with a start value, a target value, and a deadline. KPIs describe the weather. OKRs describe where you want to move the weather to this quarter."
  - q: "Should product marketing OKRs be revenue-based?"
    a: "Some should, some should not. Revenue-adjacent KRs (pipeline influenced, win rate in a segment, launch ARR) keep PMM accountable to the business. But positioning, messaging clarity, and sales confidence are leading indicators and belong in OKRs too. A PMM team measured only on revenue will end up doing sales enablement at the cost of strategic work."
---
...
An OKR has two parts. The **objective** is a short, qualitative statement of what you want to be true at the end of the quarter. The **key results** are the 2-4 measurable outcomes that prove you got there. [As What Matters (John Doerr's site) documents](https://www.whatmatters.com/faqs/okr-meaning-definition-example), "the OKR methodology was created by Andy Grove at Intel and taught to John Doerr by him," with Doerr later introducing the philosophy to Google's founders in 1999.
...
![Product marketing OKR framework showing objective and key results structure](/assets/blog/product-marketing-okrs/okr-framework.webp "Product Marketing OKR Framework")
...
For more on launch planning, see our guide on the [go-to-market strategy template](/blog/go-to-market-strategy-template/).
...
For tactics, see [competitive intelligence analysis](/blog/competitive-intelligence-analysis/) and the [competitive battlecard template](/blog/competitive-battlecard-template/).
...
- **Aim for stretch, not safety.** Google's [re:Work OKR guide](https://rework.withgoogle.com/en/guides/set-goals-with-okrs) describes the sweet spot for an OKR grade as 60-70% - if a team consistently fully attains its objectives, the OKRs are not ambitious enough.
...
Score OKRs on a 0.0 to 1.0 scale. An average of 0.6 to 0.7 is the [expected range under Google's model](https://rework.withgoogle.com/en/guides/set-goals-with-okrs) - anything consistently at 1.0 signals the goals were not ambitious enough, and anything routinely below 0.4 signals the team is missing meaningfully. The scoring is a prompt for reflection, not a performance review.

At the end of the quarter, hold a 60-minute retro with three questions:

1. Which KRs did we hit and what made them land?
2. Which did we miss and was it the goal, the tactics, or something outside our control?
3. What would we write differently if we were starting next quarter today?
...
If you are building the PMM function from scratch, pair these OKRs with a clear view of the role itself: see [what does a product marketing manager do](/blog/what-does-a-product-marketing-manager-do/) and [what is product marketing](/blog/what-is-product-marketing/) to anchor scope before you write your first objective.
