...
img_alt: Brand architecture spectrum from branded house through sub-brand and endorsed brand to house of brands, with a weighted scorecard deciding whether a launch earns its own name
faqs:
  ...
  - q: "Is Coca-Cola a branded house or house of brands?"
    a: "House of brands, with a flagship strong enough that people mistake it for a branded house. The Coca-Cola Company says it markets 200+ brands, and names like Sprite, Fanta, Costa Coffee and Topo Chico share an owner rather than a name. The Coca-Cola trademark is one brand in that portfolio, not the roof over it."
  - q: "Is Google a branded house or house of brands?"
    a: "Both, depending on which entity you mean. Google itself is a branded house: Google Search, Google Maps, Google Cloud and Google Workspace all sit under one name. Its parent Alphabet behaves more like a house of brands, holding independent companies such as Waymo, whose own site notes it was established under Alphabet."
  - q: "What is the difference between branded house and endorsed brand?"
    a: "In a branded house the master brand is the product name and everything after it is a descriptor. In an endorsed brand the product has a name that could stand on its own, and the parent appears in a supporting role, usually as a 'by' or 'from' line. Endorsement lends credibility without making the parent accountable for the entire promise."
  - q: "What is meant by brand architecture?"
    a: "Brand architecture is the set of rules deciding which things in your portfolio get their own name, which inherit the master brand, and how those names relate to each other in market. It covers naming, endorsement, visual hierarchy and, above all, which brand the buyer is being asked to trust at the point of purchase."
---
...
![Brand architecture spectrum showing branded house, sub-brand, endorsed brand and house of brands as four stacked models with examples](/assets/blog/house-of-brands-vs-branded-house/brand-architecture-models.webp "The four brand architecture models on a spectrum")
...
Exit optionality is the row people underrate, and Unilever paid it a very public compliment. In March 2024 the company announced it would separate its Ice Cream business, a portfolio whose [brands together delivered turnover of EUR 7.9 billion in 2023](https://www.unilever.com/news/press-and-media/press-releases/2024/unilever-to-accelerate-growth-action-plan-through-separation-of-ice-cream-and-launch-of-productivity-programme/) and which included Wall's, Magnum and Ben & Jerry's. That separation has since completed, with [the business now operating standalone as The Magnum Ice Cream Company](https://www.unilever.com/investors/the-magnum-ice-cream-company-demerger/).

None of that is available if the ice cream had shipped as "Unilever Frozen Desserts." You cannot demerge an adjective.

The cost of that optionality is paid every day in the other direction. [The Coca-Cola Company markets 200+ brands](https://www.coca-colacompany.com/brands), and [P&G runs five sector business units across 10 product categories](https://us.pg.com/structure-and-governance/corporate-structure/). Both companies fund awareness for dozens of names that share nothing but an owner, deliberately, because retail shelf economics reward it. Software economics usually do not.
...
- **Apple** is close to a pure branded house: iPhone, iPad, Mac, Apple Watch, Apple Music. The instructive bit is the carve-out. Apple owns Beats and still runs it under its own name, to the point that its newsroom credits an executive as ["vice president of Apple Music and Beats"](https://www.apple.com/newsroom/2022/12/apple-introduces-apple-music-sing/). Even the strictest branded house keeps an exception for an acquired brand with its own audience.
- **Google and Alphabet** give two different answers inside one company. Google is a branded house. Alphabet behaves like a house of brands: [Waymo's own site notes it "was established under Alphabet"](https://waymo.com/company/), and nothing about the Waymo brand asks you to think about Search.
...
- **Marriott** runs endorsement at scale. Its brand list includes [Fairfield by Marriott, Delta Hotels by Marriott and Homes & Villas by Marriott Bonvoy](https://www.marriott.com/marriott-brands.mi), each keeping its own name while renting the parent's trust for the booking decision.
...
Without that rule, hybrid means every naming decision gets relitigated from scratch and the answer tracks seniority rather than logic. The rule belongs in the same document as your [brand guidelines](/blog/what-are-brand-guidelines/), next to the logo lockups it will govern.
...
![Weighted launch scorecard with eight criteria and three score bands deciding between a feature name, a sub-brand and a standalone brand](/assets/blog/house-of-brands-vs-branded-house/launch-naming-scorecard.webp "The sub-brand or master brand launch scorecard")
...
|---|---|
| **Trademark registration and renewal** | [USD 350 per class for a base US application](https://www.uspto.gov/learning-and-resources/fees-and-payment/uspto-fee-schedule). In the EU, [the basic online fee is EUR 850 for one class, EUR 50 for a second and EUR 150 for each class beyond that](https://www.euipo.europa.eu/en/trade-marks/before-applying/fees-payments), renewable every 10 years. Multiply by every class and every market you sell in. |
...
| **Search authority from zero** | A new domain inherits none of your rankings. Google's own guidance on site moves is a fair proxy for how slowly search equity travels: it says a medium-sized move can take "a few weeks or more" and advises keeping [redirects in place for at least a year](https://developers.google.com/search/docs/crawling-indexing/site-move-with-url-changes) so signals transfer. |
| **Review-site presence** | To appear on a G2 Grid, [a product needs at least 10 reviews in that category, and the category needs at least six products with 10+ reviews and 150+ reviews overall](https://documentation.g2.com/docs/research-scoring-methodologies). Your master brand's reviews do not count toward any of it. |
| **Collateral and enablement** | Its own deck, one-pagers, demo script, objection handling and [battlecards](/blog/competitive-battlecard-template/), plus onboarding for every rep who now carries two stories. |
| **Analyst coverage** | A separate briefing cycle, a separate vendor profile, and separate inclusion criteria in every evaluation. That is a real addition to your [analyst relations](/blog/analyst-relations/) calendar, not a rounding error. |
| **Paid brand defence** | Competitors can bid on the new brand name, because Google Ads [will not restrict using trademarks as keywords](https://support.google.com/adspolicy/answer/6118). You now defend two brand terms instead of one, forever. |
...
- Atlassian merged two separately branded products into one, and [the announcement is unusually plain about it](https://www.atlassian.com/blog/announcements/the-next-era-of-jira): "We've taken the best of Jira Work Management and Jira Software to make a single project management tool ready to help any team go from good to great. And (throwback alert!) we're calling it, simply, Jira."

That is the template for the whole exercise. Two other recent fold-backs, Azure AD to Microsoft Entra ID and Bard to Gemini, are costed out surface by surface in [the rename migration table](/blog/product-naming/). The migration playbook:
