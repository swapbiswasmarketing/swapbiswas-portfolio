...
img_alt: "Product marketer mapping a B2B buyer persona across a buying committee whiteboard"
faqs:
  ...
  - q: "Why don't sales teams use buyer personas?"
    a: "Usually because the persona reads like a demographic bio instead of a selling tool. Sales ignores age and favorite apps. They use objections, trigger events, decision criteria, and the exact words a buyer uses, so a usable persona leads with those."
---
...
This is also where people confuse two related ideas. If you want the full breakdown, I wrote a dedicated piece on [ICP vs buyer persona](/blog/icp-vs-buyer-persona/), but the short version is below.
...
A structured [win-loss analysis](/blog/what-is-win-loss-analysis/) is the single highest-leverage input here, because it tells you why deals actually turned, not why you hope they did.
...
- Put objections and rebuttals into your [sales enablement checklist](/blog/sales-enablement-checklist/) and battlecards.
- Feed pains and trigger events into campaign briefs and ad copy.
- Use decision criteria to sharpen your [value proposition](/blog/what-is-a-value-proposition/) so the message and the buyer line up.
...
![The Anatomy of a Sales-Ready B2B Buyer Persona](/assets/blog/b2b-buyer-persona/persona-anatomy.webp "The Anatomy of a Sales-Ready B2B Buyer Persona")
...
This connects directly to how you position the product. A persona tells you what the buyer cares about; [product positioning](/blog/product-positioning/) tells you how to frame your product against those cares. The two documents should read like they were written by people who talked to each other, because they were.
