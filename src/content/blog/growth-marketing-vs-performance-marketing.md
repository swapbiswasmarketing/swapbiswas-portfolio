...
**Growth marketing is a full-funnel system of experiments.** It works across the entire customer lifecycle - the [AARRR "pirate metrics" funnel of acquisition, activation, retention, referral, and revenue popularized by investor Dave McClure](https://amplitude.com/blog/pirate-metrics-framework) - and optimizes for compounding value over time, not just the next conversion. Its instinct is to test the whole loop and fix wherever the biggest leak is.
...
This is the same trap I described in [product marketing vs growth marketing](/blog/product-marketing-vs-growth-marketing/): the countable work crowds out the compounding work.
...
![Where performance marketing fits inside growth marketing across the funnel](/assets/blog/growth-marketing-vs-performance-marketing/growth-vs-performance-funnel.webp "Where performance marketing fits inside the growth marketing funnel")
...
If your product is self-serve, this loop tightens further, because the product itself becomes an acquisition channel. I covered that in [product-led growth examples](/blog/product-led-growth-examples/) and the broader [SaaS growth strategy](/blog/saas-growth-strategy/) playbook. For the upstream, non-paid side of demand, the [SaaS demand generation](/blog/saas-demand-generation/) guide pairs naturally with this.
